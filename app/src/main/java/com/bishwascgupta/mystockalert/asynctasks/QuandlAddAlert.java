...
public class QuandlAddAlert extends AsyncTask<String , Integer ,String> {
    ...
    public QuandlAddAlert(Context c, View v) {
        this.context = c;
        this.rootView = v;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s!=null) {
            ...
            EditText upper_ip = (EditText) rootView.findViewById(R.id.input_upper);
            EditText lower_ip = (EditText) rootView.findViewById(R.id.input_lower);
            ...
            try {
                ...
                if(upper_ip.getText().toString().matches("[-+]?\\d*\\.?\\d+"))
                    upper = Float.parseFloat(upper_ip.getText().toString());
                if(lower_ip.getText().toString().matches("[-+]?\\d*\\.?\\d+"))
                    lower = Float.parseFloat(lower_ip.getText().toString());


                int success = db.addStockAlert(new Shares(stockname_ip.getText().toString(),
                        100f, lower, upper));
